...
get_header();
$feed_header = esc_html(get_theme_mod( 'unconditional_feed_header_title' ));
...
<?php if ( get_theme_mod( 'unconditional_home_projects_visibility' ) != 0 ) { 
$project_header = esc_html(get_theme_mod( 'unconditional_project_header_title' )); ?>
